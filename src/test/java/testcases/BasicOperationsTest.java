...
public class BasicOperationsTest extends BaseTest {
	 ...
	 CalculatorPage calculator;
	    ...
	    @Test(priority = 2, groups = {"regression"}, description =  "Verify the multiplication of two numbers")
	    ...
	    @Test(priority = 3, groups = {"sanity"}, description =  "Verify the calculation of two decimal numbers")
	    ...
	    @Test(priority = 4, groups = {"sanity"}, description =  "Verify the BOSMAD calculation of three or more numbers")
